...
export default function SignupPage() {
  ...
  const handleSignup = async () => {
    ...
    try {
      ...
      // Better Auth sets cookies automatically, but we need to wait a moment
      // Use window.location for hard redirect to ensure full page reload and cookie handling
      setTimeout(() => {
          ...
          >
            ...
            <div>
              ...
              <input
                ...
                disabled={loading}
                className="w-full px-4 py-3 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-transparent outline-none transition-all bg-white dark:bg-gray-700 text-gray-900 dark:text-white placeholder-gray-400 dark:placeholder-gray-500 disabled:opacity-50 disabled:cursor-not-allowed"
                required
              />
            </div>
            ...
            <button
              ...
              disabled={loading}
              className="w-full bg-purple-600 hover:bg-purple-700 disabled:bg-purple-400 text-white font-semibold py-3 px-4 rounded-lg transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:ring-offset-2 disabled:cursor-not-allowed shadow-lg hover:shadow-xl"
            >
              {loading ? (
